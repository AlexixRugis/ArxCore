...
`timescale 1 ps / 1 ps
module jtag_uart_mm_interconnect_0 (
	...
	wire   [99:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> bridge_0_avalon_master_agent:rp_data
	...
	wire    [1:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> jtag_uart_0_avalon_jtag_slave_agent:cp_channel
	...
	wire  [100:0] pio_0_s1_agent_rf_source_data;                                             // pio_0_s1_agent:rf_source_data -> pio_0_s1_agent_rsp_fifo:in_data
	...
	wire  [100:0] pio_0_s1_agent_rsp_fifo_out_data;                                          // pio_0_s1_agent_rsp_fifo:out_data -> pio_0_s1_agent:rf_sink_data
	...
	wire   [99:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> pio_0_s1_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                     // pio_0_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> pio_0_s1_agent:cp_channel
	...
	wire   [99:0] bridge_0_avalon_master_agent_cp_data;                                      // bridge_0_avalon_master_agent:cp_data -> router:sink_data
	...
	wire   [99:0] jtag_uart_0_avalon_jtag_slave_agent_rp_data;                               // jtag_uart_0_avalon_jtag_slave_agent:rp_data -> router_001:sink_data
	...
	wire   [99:0] pio_0_s1_agent_rp_data;                                                    // pio_0_s1_agent:rp_data -> router_002:sink_data
	...
	jtag_uart_mm_interconnect_0_router router (
	...
	jtag_uart_mm_interconnect_0_router_001 router_001 (
	...
	jtag_uart_mm_interconnect_0_router_001 router_002 (
	...
	jtag_uart_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	jtag_uart_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	jtag_uart_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	jtag_uart_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	jtag_uart_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	jtag_uart_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	jtag_uart_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
