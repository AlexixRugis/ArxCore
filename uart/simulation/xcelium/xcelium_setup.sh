...
if [ $SKIP_COM -eq 0 ]; then
  ...
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_up_rs232_counters.v"        -work rs232_0        -cdslib ./cds_libs/rs232_0.cds.lib       
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_up_rs232_in_deserializer.v" -work rs232_0        -cdslib ./cds_libs/rs232_0.cds.lib       
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_up_rs232_out_serializer.v"  -work rs232_0        -cdslib ./cds_libs/rs232_0.cds.lib       
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_up_sync_fifo.v"             -work rs232_0        -cdslib ./cds_libs/rs232_0.cds.lib       
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/uart_rs232_0.v"                    -work rs232_0        -cdslib ./cds_libs/rs232_0.cds.lib       
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/uart.v"                                                                                                     
fi
