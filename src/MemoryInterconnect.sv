module MemoryInterconnect (
  ...
  RamArbiter2to1 rom_arbiter (
      .clk(clk),
      .arstn(arstn),
      .clk_en(clk_en),
      .master1_addr(master1_addr & ~ROM_ADDR_MASK),
      .master1_write_data('0),
      .master1_wr_en(1'b0),
      .master1_wr_mask(4'b0000),
      .master1_req(master1_rom_req),
      ...
      .master2_wr_en(1'b0),
      .master2_wr_mask(4'b0000),
      .master2_req(master2_rom_req),
      .master2_data(rom_arb_master2_data),
      .master2_ack(rom_arb_master2_ack),
      .slave_addr(rom_arb_addr),
      .slave_req(rom_arb_req),
      .slave_ack(rom_arb_ack),
      .slave_data(rom_arb_data)
  );
  ...
  RamPort ram_port_inst (
      .clk(clk),
      .arstn(arstn),
      .clk_en(clk_en),
      .addr(ram_arb_addr),
      .write_data(ram_arb_write_data),
      .wr_en(ram_arb_wr_en),
      .wr_mask(ram_arb_wr_mask),
      .req(ram_arb_req),
      .data(ram_arb_data),
      .ack(ram_arb_ack),
      .ram_addr(ram_addr),
      ...
      .ram_wr_en(ram_wr_en),
      .ram_byte_en(ram_wr_mask),
      .ram_data(ram_data)
  );

  RamArbiter2to1 ram_arbiter (
      .clk(clk),
      .arstn(arstn),
      .clk_en(clk_en),
      ...
      .master2_req(master2_ram_req),
      .master2_data(ram_arb_master2_data),
      .master2_ack(ram_arb_master2_ack),
      .slave_addr(ram_arb_addr),
      .slave_req(ram_arb_req),
      .slave_ack(ram_arb_ack),
      .slave_data(ram_arb_data),
      .slave_wr_en(ram_arb_wr_en),
      .slave_wr_mask(ram_arb_wr_mask),
      .slave_write_data(ram_arb_write_data)
  );
  ...
  RamPort periph_port_inst (
      .clk(clk),
      .arstn(arstn),
      .clk_en(clk_en),
      .addr(periph_arb_addr),
      .write_data(periph_arb_write_data),
      .wr_en(periph_arb_wr_en),
      .wr_mask(periph_arb_wr_mask),
      .req(periph_arb_req),
      .data(periph_arb_data),
      .ack(periph_arb_ack),
      .ram_addr(periph_addr),
      .ram_write_data(periph_write_data),
      .ram_wr_en(periph_wr_en),
      .ram_byte_en(periph_wr_mask),
      .ram_data(periph_data)
  );

  RamArbiter2to1 periph_arbiter (
      .clk(clk),
      .arstn(arstn),
      .clk_en(clk_en),
      ...
      .master1_wr_en(master1_wr_en),
      .master1_wr_mask(master1_wr_mask),
      .master1_req(master1_periph_req),
      ...
      .master2_wr_en(master2_wr_en),
      .master2_wr_mask(master2_wr_mask),
      .master2_req(master2_periph_req),
      .master2_data(periph_arb_master2_data),
      .master2_ack(periph_arb_master2_ack),
      .slave_addr(periph_arb_addr),
      .slave_req(periph_arb_req),
      .slave_ack(periph_arb_ack),
      .slave_data(periph_arb_data),
      .slave_wr_en(periph_arb_wr_en),
      .slave_wr_mask(periph_arb_wr_mask),
  ...
  always_comb begin
    ...
    if (master1_rom_req_delay) begin
      master1_data = rom_arb_master1_data;
      master1_ack  = rom_arb_master1_ack;
    end else if (master1_ram_req_delay) begin
      master1_data = ram_arb_master1_data;
      master1_ack  = ram_arb_master1_ack;
    ...
    if (master2_rom_req_delay) begin
      master2_data = rom_arb_master2_data;
      master2_ack  = rom_arb_master2_ack;
    end else if (master2_ram_req_delay) begin
      master2_data = ram_arb_master2_data;
      master2_ack  = ram_arb_master2_ack;
