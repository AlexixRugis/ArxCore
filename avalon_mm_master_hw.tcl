...
add_interface_port conduit_end conduit_end_do_send new_signal Input 1
add_interface_port conduit_end conduit_end_rx_data new_signal_1 Output 8
add_interface_port conduit_end conduit_end_tx_data new_signal_2 Input 8
add_interface_port conduit_end conduit_end_data_valid new_signal_3 Output 1
