...
module ExecStage #(
    ...
    input alu_src1_e                     alu_src_1_in,
    input alu_src2_e                     alu_src_2_in,

    input mdu_op_e mdu_op_in,
  ...
  always_comb begin
    alu_out = m_alu_en_in ? ialu_res : (m_mdu_en_in ? imdu_res : '0);
